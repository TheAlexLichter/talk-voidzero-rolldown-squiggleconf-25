...
<template>
  <footer
    class="flex flex-col justify-between w-full mt-auto text-black dark:text-white"
  >
  ...
  <div class="absolute h-1.5 opacity-90 w-full bg-gradient-to-r from-[#6bb5f0] to-[#bd34fe] bottom-0 left-0">
  </div>
</template>